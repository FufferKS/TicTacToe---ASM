...
.data
	...
	;-------------------------------------------------------------------
	pola db 9 dup (' ')	;tu przechowywane będą stany pól				; 
...
mov al, bufor_na_input		; przeslanie wczytanego bajtu do al
				; odjęcie kodu znaku 0
cmp al, 39H					; chcę akceptować tylko cyfry od 0 do 8
jg wi_niepoprawny_input		; więc jeśli większe, do skok do obsługi 
cmp al, 31H
...
jmp wi_koniec				; zakończ procedurę
